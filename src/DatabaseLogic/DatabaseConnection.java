...
//	Imports login info keys
	...
	{
		//Her skal v�re 2 switches til at bestemme Hvilken calendar event tilh�rer, og hvilken lokation.
	...
	private int determineCalendarID(String course) {
		...
		switch (course)
		{
			...
			break;
			case "Virksomhedens �konomiske styring (3)": intToBeReturned = 15;
			break;
			case "Makro�konomi (XB)": intToBeReturned = 9;
			break;
			case "Makro�konomi (XA)": intToBeReturned = 8;
			break;
			case "Ledelse af IS - forandring, innovation og viden (XA)": intToBeReturned = 13;
			break;
			case "Makro�konomi (LA)": intToBeReturned = 10;
			break;
